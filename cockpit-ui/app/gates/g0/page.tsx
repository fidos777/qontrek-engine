...
export default function Gate0Dashboard() {
  ...
  // Calculate trust score from qualified rate
  const trustScore = Math.round(Number(summary.qualified_rate ?? 0) * 100);

  return (
    <>
      <GovernanceHeaderStrip title="Gate 0 — Lead Qualification" status="active" />
